...
public class Array1 {
    ...
    public int[] midThree(int[] nums) {
        return new int[]{nums[(nums.length - 3) / 2], nums[(nums.length - 1) / 2], nums[(nums.length + 1) / 2]};
    }
    ...
    public boolean unlucky1(int[] nums) {
        ...
        return ((nums[0] == 1 && nums[1] == 3) || (nums[nums.length - 2] == 1 && nums[nums.length - 1] == 3) || (nums[1] == 1 && nums[2] == 3));
    }
