...
public class Logic1 {
    ...
    public boolean cigarParty(int cigars, boolean isWeekend) {
        return (!isWeekend && cigars <= 60 && cigars >= 40) || (isWeekend && cigars >= 40);
    }
    ...
    public boolean squirrelPlay(int temp, boolean isSummer) {
        return temp > 59 && ((!isSummer && temp < 91) || (isSummer && temp < 101));
    }
    ...
    public boolean in1To10(int n, boolean outsideMode) {
        return (!outsideMode && n < 11 && n > 0) || (outsideMode && (n <= 1 || n >= 10));
    }
    ...
    public boolean lessBy10(int a, int b, int c) {
        return Math.min(a, Math.min(b, c)) + 10 <= Math.max(a, Math.max(b, c));
    }
    ...
    public boolean shareDigit(int a, int b) {
        return (a % 10 == b % 10 || a % 10 == doz(b) || doz(a) == b % 10 || doz(a) == doz(b));
    }

    private int doz(int n) {
        return (n - (n % 10)) / 10;
    }
    ...
    public int sumLimit(int a, int b) {
        ...
        if (aString.length() == sumString.length()) return a + b;
        return a;
    }
