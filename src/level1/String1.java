...
public String twoChar(String str, int index) {
  if(str.length()<3 || index+2>str.length() || index<0)  return str.substring(0,2);
...
public String middleThree(String str) {
  return str.substring(str.length()/2-1,str.length()/2+2);
     ...
     * 1 in the string, such as with "badxxx" or "xbadxx" but not "xxbadxx". The string may be any length, including 0.
...
public boolean frontAgain(String str) {
  ...
  return  str.endsWith(str.substring(0,2));
     ...
     * if the strings are different lengths, omit chars from the longer string so it is
...
public String withoutX2(String str) {
  if(str.startsWith("x",1))  str=str.substring(0,1)+str.substring(2);
